...
contenidoexp.insertAdjacentHTML(
  "beforeend",
  "<br><div class = 'op'><ul class = 'lista-exp'><li><b>Curso de IA con Python.</b><p>Por medio de un programa de Mintic realice un curso en platzi sobre los fundamentos de la programación en Python y su uso en el área de la inteligencia artificial, además de explorar diversas herramientas en IBM para la creación de un chatbot.</p></li><li><b>Diplomado Universidad Autónoma de Bucaramanga.</b><p>Por medio del programa de Mintic realice durante un año un diplomado con dicha universidad en el área de habilidades en programación con énfasis en aplicaciones web y durante el ultimo ciclo del diplomado dirigí mi estudio hacia el desarrollo de aplicaciones web.</p></li><li><b>Desarrollo de bases de datos con SQL</b><p>Realice varios cursos de creación y manejo de bases de datos en la plataforma de Udemy y realice exámenes de certificación en la plataforma de HackerRank.</p></li><li><b>Responsive Web Design.</b><p>Realice un curso de HTML5 y CSS3 en la plataforma de freecodecamp donde realice distintos proyectos como muestro en mi github.</p></li></ul><p>Quiero fortalecer mis conocimientos en un área laboral, donde constantemente me rete a mi mismo a mejorar profesionalmente y ser más competitivo en el área de la tecnología que me quiero especializar.</p></div><br>"
);
